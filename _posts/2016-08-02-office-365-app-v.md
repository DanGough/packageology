...
**UPDATE: This issue can now be resolved by adding a registry key, see [here]({{ site.baseurl }}{% post_url 2017-10-19-fix-office-365-app-v-interaction %}) for further details.**
{: .notice--warning}
